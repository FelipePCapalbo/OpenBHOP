...
pub fn calculate_sway(velocity: Vec3, front: Vec3) -> (f32, f32) {
    ...
    let local_x = velocity.dot(right);
    let local_y = velocity.y + velocity.dot(flat_front); // Soma inércia de frente/trás com pulo/queda
